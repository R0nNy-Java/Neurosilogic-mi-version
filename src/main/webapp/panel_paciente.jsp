    ...
    <div class="row g-0 min-vh-100">
      ...
      <div class="col nl-main-col">
        ...
        <main class="p-4">
          ...
          <div class="row g-3 mb-4">
            <div class="col-md-6">
              <div class="card border-0 shadow-sm rounded-3 h-100 p-3">
                <small class="fw-bold text-uppercase text-muted d-block mb-1" style="font-size:.7rem;letter-spacing:.6px;">Síntomas Actuales</small>
                <div class="text-dark small">
                  <%= (p.getSintomasActuales() != null && !p.getSintomasActuales().isEmpty()) ? p.getSintomasActuales() : "Sin observaciones registradas." %>
                </div>
              </div>
            </div>
            <div class="col-md-6">
              <div class="card border-0 shadow-sm rounded-3 h-100 p-3">
                <small class="fw-bold text-uppercase text-muted d-block mb-1" style="font-size:.7rem;letter-spacing:.6px;">Alergias & Antecedentes Clínicos</small>
                <div class="d-flex flex-wrap gap-2">
                  <% if (p.getAlergias() != null && !p.getAlergias().trim().isEmpty()) { %>
                    <span class="badge bg-danger text-white"><i class="bi bi-exclamation-triangle-fill me-1"></i>Alergia: <%= p.getAlergias() %></span>
                  <% } %>
                  <%
                    if (antecedentes != null && !antecedentes.isEmpty()) {
                        for (Antecedente ant : antecedentes) {
                  %>
                    <span class="badge bg-success bg-opacity-10 text-success border border-success border-opacity-25"><%= ant.getEnfermedad() %></span>
                  <%    }
                    } else { %>
          ...
          <!-- MÓDULOS DE ATENCIÓN DE PACIENTE (Exactamente 4 Columnas como index.jsp) -->
          ...
          <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-4 g-3 mb-4">
            ...
            <!-- 2. MÓDULO DOSIFICACIÓN Y ADMINISTRACIÓN -->
            <div class="col">
          ...
          <div class="card border-0 shadow-sm rounded-4 overflow-hidden mt-4">
            <div class="card-body p-4 text-center bg-white">
              ...
              <a href="${pageContext.request.contextPath}/PacientesServlet" class="btn btn-outline-danger py-3 px-5 fw-semibold d-inline-flex align-items-center justify-content-center gap-2 shadow-sm rounded-3">
